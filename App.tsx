...
const App: React.FC = () => {
  ...
  return (
    <div className="min-h-screen bg-[#fcfcfd] flex flex-col max-w-md mx-auto shadow-xl ring-1 ring-gray-100 relative">
      <header className="sticky top-0 z-30 bg-white/95 backdrop-blur-md border-b border-gray-100 px-6 py-5">
      ...
      <footer className="sticky bottom-0 bg-white border-t border-gray-100 p-4 safe-bottom z-40">
